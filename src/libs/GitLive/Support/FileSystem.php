            ...
            ['notification' =>
                function ($notification_code, $severity, $message, $message_code, $bytes_transferred, $bytes_max) {
                    ...
                    case STREAM_NOTIFY_REDIRECTED:
                        echo __('Being redirected to') . ': ', $message;
                    ...
                    case STREAM_NOTIFY_FILE_SIZE_IS:
                        echo __('Got the file size') . ': ', $bytes_max;

                        break;
                    case STREAM_NOTIFY_MIME_TYPE_IS:
                        echo __('Found the mime-type') . ': ', $message;

                        break;
                    case STREAM_NOTIFY_PROGRESS:
                        echo sprintf(__('Made some progress, downloaded %s so far'), $bytes_transferred);
