...
#[\PHPUnit\Framework\Attributes\CoversClass(\GitLive\Command\Release\ReleaseSyncCommand::class)]
...
class ReleaseSyncCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->assertEquals([
            ...
            23 => "git checkout release/unit_test_deploy",
            24 => "git pull deploy release/unit_test_deploy",
            25 => "git pull upstream release/unit_test_deploy",
            26 => "git push upstream release/unit_test_deploy",
            27 => "git push deploy release/unit_test_deploy",
        ], data_get($this->spy, '*.0'));
