...
#[\PHPUnit\Framework\Attributes\CoversClass(\GitLive\Command\Release\ReleasePullCommand::class)]
...
class ReleasePullCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $command = $application->find('release:pull');
