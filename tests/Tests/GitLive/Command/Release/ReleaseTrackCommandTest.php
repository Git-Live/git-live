...
#[\PHPUnit\Framework\Attributes\CoversClass(\GitLive\Command\Release\ReleaseTrackCommand::class)]
...
class ReleaseTrackCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $command = $application->find('release:track');
