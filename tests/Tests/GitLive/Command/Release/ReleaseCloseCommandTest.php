...
class ReleaseCloseCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->assertEquals([
            ...
            26 => "git format-patch `git rev-parse --abbrev-ref HEAD`..deploy/release/unit_test_deploy --stdout| git apply --check",
            ...
            31 => "git checkout upstream/develop",
            32 => "git branch -D develop",
            33 => "git checkout -b develop",
            34 => "git symbolic-ref HEAD 2>/dev/null",
            35 => "git merge deploy/release/unit_test_deploy",
            36 => "git diff deploy/release/unit_test_deploy develop",
            37 => "git push upstream develop",
