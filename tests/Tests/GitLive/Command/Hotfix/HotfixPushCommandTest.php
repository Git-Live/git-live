...
#[\PHPUnit\Framework\Attributes\CoversClass(\GitLive\Command\Hotfix\HotfixPushCommand::class)]
...
class HotfixPushCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->assertEquals([
            ...
            22 => "git checkout hotfix/unit_test_deploy",
            23 => "git pull upstream hotfix/unit_test_deploy",
            24 => "git pull deploy hotfix/unit_test_deploy",
            25 => "git status hotfix/unit_test_deploy",
