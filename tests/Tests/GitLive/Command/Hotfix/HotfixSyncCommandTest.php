...
#[\PHPUnit\Framework\Attributes\CoversClass(\GitLive\Command\Hotfix\HotfixSyncCommand::class)]
...
class HotfixSyncCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $command = $application->find('hotfix:sync');
        ...
        $this->assertEquals([
            ...
            22 => "git branch --no-color",
            23 => "git checkout hotfix/unit_test_deploy",
            24 => "git pull deploy hotfix/unit_test_deploy",
            25 => "git pull upstream hotfix/unit_test_deploy",
            26 => "git push upstream hotfix/unit_test_deploy",
            27 => "git push deploy hotfix/unit_test_deploy",
        ], data_get($this->spy, '*.0'));
