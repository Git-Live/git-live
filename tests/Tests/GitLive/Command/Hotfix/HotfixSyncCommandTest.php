...
class HotfixSyncCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->assertEquals([
            ...
            15 => 'git branch -a',
            16 => 'git branch -a',
            17 => 'git status hotfix/unit_test_deploy',
            18 => 'git branch',
            19 => 'git checkout hotfix/unit_test_deploy',
            20 => 'git pull deploy hotfix/unit_test_deploy',
            21 => 'git pull upstream hotfix/unit_test_deploy',
            22 => 'git push upstream hotfix/unit_test_deploy',
            23 => 'git push deploy hotfix/unit_test_deploy',
        ], data_get($this->spy, '*.0'));
