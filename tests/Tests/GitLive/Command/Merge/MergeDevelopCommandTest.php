...
#[\PHPUnit\Framework\Attributes\CoversClass(\GitLive\Command\Merge\MergeDevelopCommand::class)]
...
class MergeDevelopCommandTest extends TestCase
{
    ...
    public function testExecute()
    {
        ...
        $command = $application->find('merge:develop');
